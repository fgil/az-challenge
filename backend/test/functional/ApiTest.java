...
public class ApiTest extends FunctionalTest {
  ...
  public void singlePlayerTest() throws Exception {
    ...
    String reply2 = POST("/guess", String.format( "{ \"code\":\"RGOOOOOB\", \"game_key\": \"%d\", \"user\":\"Fernando\" }", game.id));
    assertEquals(String.format("{\"code_length\":8,\"colors\":[\"R\",\"B\",\"G\",\"Y\",\"P\",\"O\",\"C\",\"M\"],"
        ...
        + "\"players\":\"Fernando vs null\",\"game_state\":\"STARTED\",\"is_multiplayer\":false}", game.id), reply2);

    // Try a correct answer
    String reply3 = POST("/guess", String.format( "{ \"code\":\"RBGGGGGG\", \"game_key\": \"%d\", \"user\":\"Fernando\" }", game.id));
    ...
    assertEquals(String.format("{\"code_length\":8,\"colors\":[\"R\",\"B\",\"G\",\"Y\",\"P\",\"O\",\"C\",\"M\"],"
        ...
        + "\"players\":\"Fernando vs null\",\"game_state\":\"FINISHED\",\"is_multiplayer\":false}", game.id, time), reply3);
  }
  ...
  public void multiPlayerTest() throws Exception {
    ...
    String reply3 = POST("/guess", String.format( "{ \"code\":\"RGOOOOOB\", \"game_key\": \"%d\", \"user\":\"Fernando\" }", game.id));
    ...
    assertEquals(String.format("{\"code_length\":8,\"colors\":[\"R\",\"B\",\"G\",\"Y\",\"P\",\"O\",\"C\",\"M\"],"
        + "\"game_key\":\"%d\",\"num_guesses\":0,\"past_results\":[],\"past_results_opponent\":[],"
        + "\"solved\":\"false\",\"players\":\"Fernando vs Luciana\",\"game_state\":\"STARTED\",\"is_multiplayer\":true}", game.id), reply5);

    // First player try an incorrect guess
    String reply6 = POST("/guess", String.format( "{ \"code\":\"RGOOOOOB\", \"game_key\": \"%d\", \"user\":\"Fernando\" }", game.id));
    assertEquals(String.format("{\"code_length\":8,\"colors\":[\"R\",\"B\",\"G\",\"Y\",\"P\",\"O\",\"C\",\"M\"],"
        + "\"game_key\":\"%d\",\"guess\":\"RGOOOOOB\",\"num_guesses\":1,"
        + "\"past_results\":[{\"exact\":1,\"guess\":\"RGOOOOOB\",\"near\":2}],\"past_results_opponent\":[],"
        + "\"result\":{\"exact\":1,\"near\":2},\"solved\":\"false\",\"user\":\"Fernando\","
    ...
    String reply7 = POST("/guess", String.format( "{ \"code\":\"BROOOOOG\", \"game_key\": \"%d\", \"user\":\"Luciana\" }", game.id));
    assertEquals(String.format("{\"code_length\":8,\"colors\":[\"R\",\"B\",\"G\",\"Y\",\"P\",\"O\",\"C\",\"M\"],"
    ...
    String reply8 = POST("/guess", String.format( "{ \"code\":\"RBGGGGGG\", \"game_key\": \"%d\", \"user\":\"Fernando\" }", game.id));
    game = ObjectifyService.query(Game.class).get();
    String time = String.format("%.03f", (double)(game.finishedAt.getTime() - game.startedAt.getTime())/1000);
    time = time.replace(",", ".");
    assertEquals(String.format("{\"code_length\":8,\"colors\":[\"R\",\"B\",\"G\",\"Y\",\"P\",\"O\",\"C\",\"M\"],"
        ...
        + "\"players\":\"Fernando vs Luciana\",\"game_state\":\"FINISHED\",\"is_multiplayer\":false}", game.id, time), reply8);

    // Second player guesses and receive a bad news
    String reply9 = POST("/guess", String.format( "{ \"code\":\"BROOOOOG\", \"game_key\": \"%d\", \"user\":\"Luciana\" }", game.id));
    assertEquals(String.format("{\"code_length\":8,\"colors\":[\"R\",\"B\",\"G\",\"Y\",\"P\",\"O\",\"C\",\"M\"],"
        ...
        + "\"players\":\"Fernando vs Luciana\",\"game_state\":\"FINISHED\",\"is_multiplayer\":false}", game.id, time), reply9);
  }
